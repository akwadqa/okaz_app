...
@HiveField(0) String get token;@HiveField(1)@JsonKey(name: "full_name") String get fullName;@HiveField(2)@JsonKey(name: "mobile_no") String get mobileNumber;@HiveField(3) String? get email;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,token,fullName,mobileNumber,email);
...
@useResult
$Res call({
@HiveField(0) String token,@HiveField(1)@JsonKey(name: "full_name") String fullName,@HiveField(2)@JsonKey(name: "mobile_no") String mobileNumber,@HiveField(3) String? email
});
...
/// Create a copy of UserInformation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? token = null,Object? fullName = null,Object? mobileNumber = null,Object? email = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String token, @HiveField(1)@JsonKey(name: "full_name")  String fullName, @HiveField(2)@JsonKey(name: "mobile_no")  String mobileNumber, @HiveField(3)  String? email)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserInformation() when $default != null:
return $default(_that.token,_that.fullName,_that.mobileNumber,_that.email);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String token, @HiveField(1)@JsonKey(name: "full_name")  String fullName, @HiveField(2)@JsonKey(name: "mobile_no")  String mobileNumber, @HiveField(3)  String? email)  $default,) {final _that = this;
switch (_that) {
case _UserInformation():
return $default(_that.token,_that.fullName,_that.mobileNumber,_that.email);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)  String token, @HiveField(1)@JsonKey(name: "full_name")  String fullName, @HiveField(2)@JsonKey(name: "mobile_no")  String mobileNumber, @HiveField(3)  String? email)?  $default,) {final _that = this;
switch (_that) {
case _UserInformation() when $default != null:
return $default(_that.token,_that.fullName,_that.mobileNumber,_that.email);case _:
  return null;
...
class _UserInformation implements UserInformation {
   _UserInformation({@HiveField(0) required this.token, @HiveField(1)@JsonKey(name: "full_name") required this.fullName, @HiveField(2)@JsonKey(name: "mobile_no") required this.mobileNumber, @HiveField(3) required this.email});
...
/// Create a copy of UserInformation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? token = null,Object? fullName = null,Object? mobileNumber = null,Object? email = freezed,}) {
