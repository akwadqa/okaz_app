...
import 'package:okaz/features/settings/presentation/screens/terms_and_conditions_screen.dart';
...
import '../../../features/auth/verification/presentation/screens/verification_account_screen.dart';
import '../../../features/filter/presentation/screens/filters_screen.dart';
import '../../../features/filter/presentation/screens/products_screen.dart';
import '../../../features/filter/presentation/screens/search_sub_categories_screen.dart';
import '../../../features/home/domain/model/home_model/home_model.dart';
...
import '../../../features/update_post/presentaion/screens/update_post_screen.dart';
  ...
  static GoRouter _createRouter(Ref ref) {
    ...
    return GoRouter(
      ...
      routes: <RouteBase>[
        ...
        GoRoute(
          path: AppRoutes.updatePost,
          name: AppRoutes.updatePost,
          parentNavigatorKey: rootKey,
          pageBuilder: (BuildContext context, GoRouterState state) {
            return CustomTransitionPage(
