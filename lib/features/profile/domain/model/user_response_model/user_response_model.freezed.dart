...
@JsonKey(name: 'first_name') String? get firstName;@JsonKey(name: 'last_name') String? get lastName;@JsonKey(name: 'mobile_number') String? get mobileNumber; String? get country; String? get image; String? get email;@JsonKey(name: 'created_on') String? get createdOn;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,firstName,lastName,mobileNumber,country,image,email,createdOn);
...
@useResult
$Res call({
@JsonKey(name: 'first_name') String? firstName,@JsonKey(name: 'last_name') String? lastName,@JsonKey(name: 'mobile_number') String? mobileNumber, String? country, String? image, String? email,@JsonKey(name: 'created_on') String? createdOn
});
...
/// Create a copy of UserResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? firstName = freezed,Object? lastName = freezed,Object? mobileNumber = freezed,Object? country = freezed,Object? image = freezed,Object? email = freezed,Object? createdOn = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'first_name')  String? firstName, @JsonKey(name: 'last_name')  String? lastName, @JsonKey(name: 'mobile_number')  String? mobileNumber,  String? country,  String? image,  String? email, @JsonKey(name: 'created_on')  String? createdOn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserResponseModel() when $default != null:
return $default(_that.firstName,_that.lastName,_that.mobileNumber,_that.country,_that.image,_that.email,_that.createdOn);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'first_name')  String? firstName, @JsonKey(name: 'last_name')  String? lastName, @JsonKey(name: 'mobile_number')  String? mobileNumber,  String? country,  String? image,  String? email, @JsonKey(name: 'created_on')  String? createdOn)  $default,) {final _that = this;
switch (_that) {
case _UserResponseModel():
return $default(_that.firstName,_that.lastName,_that.mobileNumber,_that.country,_that.image,_that.email,_that.createdOn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'first_name')  String? firstName, @JsonKey(name: 'last_name')  String? lastName, @JsonKey(name: 'mobile_number')  String? mobileNumber,  String? country,  String? image,  String? email, @JsonKey(name: 'created_on')  String? createdOn)?  $default,) {final _that = this;
switch (_that) {
case _UserResponseModel() when $default != null:
return $default(_that.firstName,_that.lastName,_that.mobileNumber,_that.country,_that.image,_that.email,_that.createdOn);case _:
  return null;
...
class _UserResponseModel implements UserResponseModel {
  const _UserResponseModel({@JsonKey(name: 'first_name') this.firstName, @JsonKey(name: 'last_name') this.lastName, @JsonKey(name: 'mobile_number') this.mobileNumber, this.country, this.image, this.email, @JsonKey(name: 'created_on') this.createdOn});
...
/// Create a copy of UserResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? firstName = freezed,Object? lastName = freezed,Object? mobileNumber = freezed,Object? country = freezed,Object? image = freezed,Object? email = freezed,Object? createdOn = freezed,}) {
