...
mixin _$ProfileState {
  ...
  List<ProfileItem> get myAds;
  List<ProfileItem> get favorites;
...
abstract mixin class $ProfileStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<ProfileItem> myAds,
      List<ProfileItem> favorites});
}
...
extension ProfileStatePatterns on ProfileState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(ProfileTab selectedTab, List<ProfileItem> myAds,
            List<ProfileItem> favorites)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ProfileState() when $default != null:
        return $default(_that.selectedTab, _that.myAds, _that.favorites);
      case _:
        return orElse();
    }
  }
...
class _ProfileState implements ProfileState {
  const _ProfileState(
      ...
      final List<ProfileItem> myAds = const [],
      final List<ProfileItem> favorites = const []})
      : _myAds = myAds,
