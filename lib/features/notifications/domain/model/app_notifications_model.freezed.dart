...
@JsonKey(name: 'content') String get emailContent; String get subject;@JsonKey(name: "creation") DateTime get creation;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppNotificationsModel&&(identical(other.emailContent, emailContent) || other.emailContent == emailContent)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.creation, creation) || other.creation == creation));
}
...
@useResult
$Res call({
@JsonKey(name: 'content') String emailContent, String subject,@JsonKey(name: "creation") DateTime creation
});
...
/// Create a copy of AppNotificationsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? emailContent = null,Object? subject = null,Object? creation = null,}) {
  return _then(_self.copyWith(
emailContent: null == emailContent ? _self.emailContent : emailContent // ignore: cast_nullable_to_non_nullable
as String,subject: null == subject ? _self.subject : subject // ignore: cast_nullable_to_non_nullable
as String,creation: null == creation ? _self.creation : creation // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'content')  String emailContent,  String subject, @JsonKey(name: "creation")  DateTime creation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppNotificationsModel() when $default != null:
return $default(_that.emailContent,_that.subject,_that.creation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'content')  String emailContent,  String subject, @JsonKey(name: "creation")  DateTime creation)  $default,) {final _that = this;
switch (_that) {
case _AppNotificationsModel():
return $default(_that.emailContent,_that.subject,_that.creation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'content')  String emailContent,  String subject, @JsonKey(name: "creation")  DateTime creation)?  $default,) {final _that = this;
switch (_that) {
case _AppNotificationsModel() when $default != null:
return $default(_that.emailContent,_that.subject,_that.creation);case _:
  return null;
...
class _AppNotificationsModel implements AppNotificationsModel {
  const _AppNotificationsModel({@JsonKey(name: 'content') required this.emailContent, required this.subject, @JsonKey(name: "creation") required this.creation});
  factory _AppNotificationsModel.fromJson(Map<String, dynamic> json) => _$AppNotificationsModelFromJson(json);

// @JsonKey(name: 'for_user') required String forUser,
@override@JsonKey(name: 'content') final  String emailContent;
@override final  String subject;
@override@JsonKey(name: "creation") final  DateTime creation;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppNotificationsModel&&(identical(other.emailContent, emailContent) || other.emailContent == emailContent)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.creation, creation) || other.creation == creation));
}
...
/// Create a copy of AppNotificationsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? emailContent = null,Object? subject = null,Object? creation = null,}) {
